...
func (t Training) TrainingInfo() InfoMessage {
	...
	msg := InfoMessage{TrainingType: trainingType, Duration: duration, Distance: distance,
...
func (r Running) Calories() float64 {
	...
	calories := ((CaloriesMeanSpeedMultiplier*MeanSpeed + CaloriesMeanSpeedShift) *
...
func (w Walking) Calories() float64 {
	...
	SqMeanSpeedInMs := math.Pow(w.meanSpeed()*KmHInMsec, 2)
	HeightInM := w.Height * CaloriesSpeedHeightMultiplier

	calories := ((CaloriesWeightMultiplier*w.Weight + (SqMeanSpeedInMs/HeightInM)*
